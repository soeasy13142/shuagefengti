...
| `2026-07-19-sync-viz-design.md` | 同步互斥演示 | 操作系统 |
| `2026-07-12-sha256-design.md` | SHA-256 演示 | 密码学 |
| `2026-07-19-rsa-calc-design.md` | RSA 演算器 | 密码学 |
| `2026-07-19-aes-viz-design.md` | AES 演示 | 密码学 |
| `2026-07-19-dh-viz-design.md` | DH 密钥交换 | 密码学 |
| `2026-07-19-crypto-tools-design.md` | 密码工具箱 | 密码学 |
| `2026-07-12-bplus-tree-design.md` | B+ 树可视化 | 算法 & 数据结构 |
| `2026-07-19-regex-dfa-design.md` | Regex→DFA | 编译原理 |
| `2026-07-19-ll1-parser-design.md` | LL(1) 分析器 | 编译原理 |
| `2026-07-19-lexer-viz-design.md` | 词法分析器 | 编译原理 |
| `2026-07-19-ast-builder-design.md` | AST 构建器 | 编译原理 |

另外 4 个已上线工具（subnet-calc、tcp-viz、sort-viz、ds-viz）在本目录没有独立的 spec 文件——它们是在 brainstorming 工作流建立之前开发的。

### 📋 待实现

🎉 **全部工具已上线！** 25/25 工具 `available: true`，无待实现工具。
