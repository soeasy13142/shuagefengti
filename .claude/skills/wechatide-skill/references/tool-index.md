...
| `simulator_screenshot` | debugger | 截图；支持 wait / waitForSelector 和本地 path。 |
...
| `automation_viewport_action` | automator | 执行滚动、截图、真机调试或关闭工具；支持操作前等待。screenshot 可被 automation_generate_script 记录。 |
